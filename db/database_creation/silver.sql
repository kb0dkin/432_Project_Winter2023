...
WITH(reverse_geocode(POINT(t_t.dropoff_centroid_longitude, t_t.dropoff_centroid_latitude), 'us')) AS (zip int, city varchar(100), state varchar(100), country varchar(100))
